...
object DecoderTable {
  ...
  val decMap = Array(
    ...
    Insts.SLLI  -> List(InstType.IS, OptCode.SLL),
    Insts.SRLI  -> List(InstType.IS, OptCode.SRL),
    Insts.SRAI  -> List(InstType.IS, OptCode.SRA),
    ...
    Insts.SYS   -> List(InstType.SYS, OptCode.ADD), // ecall and csr
